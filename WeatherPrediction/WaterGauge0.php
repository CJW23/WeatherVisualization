...
<?php
    include "getdata.php";
    $data = CityAvgHumi($collection, $code);
 ?>
<svg id="fillgauge5" width="100%" height="300"></svg><br><br>
<div id="region" class="jua" style="font-size:45px;"></div>

<script>
    d3.select("#region").text("<?php echo $city ?>");
...
function colores_google(n) {
  var colores_g = ["#B2EBF4", "#B7F0B1", "#FAED7D", "#B2CCFF", "#D1B2FF"];
