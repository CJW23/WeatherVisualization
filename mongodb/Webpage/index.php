							...
							<!-- Banner -->
								<section id="banner">
									<div class="content">
										...
										<div style="width:24%;float:left;margin-right:5px;">
											<select name="city" id="demo-category">
											<option value="" disabled selected>- FIRST REGION -</option>
										...
										<div style="width:24%;float:left;margin-right:5px;">
											...
											<option value="" disabled selected>- SECOND REGION -</option>
											<option value="" disabled>** 서울특별시 **</option>
											<option value="관악산">관악산</option>
											<option value="서울">서울</option>
											<option value="" disabled>** 부산광역시 **</option>
										...
										<div style="width:24%;float:left;margin-right:5px;">
											...
											<option value="" disabled selected>- THIRD REGION -</option>
											<option value="" disabled>** 서울특별시 **</option>
											<option value="관악산">관악산</option>
											<option value="서울">서울</option>
											<option value="" disabled>** 부산광역시 **</option>
										...
										<div style="width:24%;float:left;">
											...
											<option value="" disabled selected>- FOURTH REGION -</option>
											<option value="" disabled>** 서울특별시 **</option>
											<option value="관악산">관악산</option>
											<option value="서울">서울</option>
											<option value="" disabled>** 부산광역시 **</option>
										...
										<div style="width:24%;float:left;margin-top:5px;margin-right:5px;">
											<select name="num" id="demo-category">
											<option value="" disabled selected>- SELECT DISPLAY NUMBER -</option>
